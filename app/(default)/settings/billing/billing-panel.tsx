  ...
  return (
    <div className="grow">
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Billing Information */}
        <section>
          <h3 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-1">{t('billingInformation')}</h3>
          <ul>
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              {/* Left */}
              <div className="text-sm text-gray-800 dark:text-gray-100 font-medium">{t('paymentMethod')}</div>
              {/* Right */}
              <div className="text-sm text-gray-600 dark:text-gray-400 ml-4">
                <span className="mr-3">Mastercard ending 9282</span>
                <a className="font-medium text-violet-500 hover:text-violet-600 dark:hover:text-violet-400" href="#0">{t('edit')}</a>
              </div>
            </li>
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              {/* Left */}
              <div className="text-sm text-gray-800 dark:text-gray-100 font-medium">{t('billingInterval')}</div>
              {/* Right */}
              <div className="text-sm text-gray-600 dark:text-gray-400 ml-4">
            ...
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              {/* Left */}
              <div className="text-sm text-gray-800 dark:text-gray-100 font-medium">{t('vatGstNumber')}</div>
              {/* Right */}
              <div className="text-sm text-gray-600 dark:text-gray-400 ml-4">
            ...
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              {/* Left */}
              <div className="text-sm text-gray-800 dark:text-gray-100 font-medium">{t('yourAddress')}</div>
              {/* Right */}
              <div className="text-sm text-gray-600 dark:text-gray-400 ml-4">
            ...
            <li className="md:flex md:justify-between md:items-center py-3 border-b border-gray-200 dark:border-gray-700/60">
              {/* Left */}
              <div className="text-sm text-gray-800 dark:text-gray-100 font-medium">{t('billingAddress')}</div>
              {/* Right */}
              <div className="text-sm text-gray-600 dark:text-gray-400 ml-4">
        ...
        {/* Invoices */}
        <section>
          <h3 className="text-xl leading-snug text-gray-800 dark:text-gray-100 font-bold mb-1">{t('invoices')}</h3>
          {/* Table */}
            ...
            <thead className="text-xs uppercase text-gray-400 dark:text-gray-500">
              <tr className="flex flex-wrap md:table-row md:flex-no-wrap">
                <th className="w-full block md:w-auto md:table-cell py-2">
                  <div className="font-semibold text-left">{t('year')}</div>
                </th>
                <th className="w-full hidden md:w-auto md:table-cell py-2">
                  <div className="font-semibold text-left">{t('plan')}</div>
                </th>
                <th className="w-full hidden md:w-auto md:table-cell py-2">
                  <div className="font-semibold text-left">{t('amount')}</div>
                </th>
                <th className="w-full hidden md:w-auto md:table-cell py-2">
