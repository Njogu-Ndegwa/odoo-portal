  ...
  return (
    <div className="grow">
      ...
      <div className="p-6 space-y-6">
        ...
        <section>
          <div className="mb-8">
            <h2 className="text-2xl text-gray-800 dark:text-gray-100 font-bold mb-4">{t('title')}</h2>
          ...
          <div>
            ...
            <div className="flex items-center space-x-3 mb-6">
              <div className="text-sm text-gray-500 font-medium">{t('monthly')}</div>
              <div className="form-switch">
                <input type="checkbox" id="toggle" className="sr-only" checked={annual} onChange={() => setAnnual(!annual)} />
                <label htmlFor="toggle">
                  <span className="bg-white shadow-sm" aria-hidden="true"></span>
                  <span className="sr-only">{t('payAnnually')}</span>
                </label>
              </div>
              <div className="text-sm text-gray-500 font-medium">{t('annually')} <span className="text-green-500">{t('discount')}</span></div>
            </div>
            {/* Pricing tabs */}
              ...
              <div className="relative col-span-full xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg text-gray-800 dark:text-gray-100 font-semibold">{t('basic')}</h3>
                  </header>
                  ...
                  {/* CTA */}
                  <button className="btn border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 text-gray-800 dark:text-gray-300 w-full">{t('downgrade')}</button>
                </div>
                <div className="px-5 pt-4 pb-5">
                  <div className="text-xs text-gray-800 dark:text-gray-100 font-semibold uppercase mb-4">{t('whatsIncluded')}</div>
                  {/* List */}
                  <ul>
              ...
              <div className="relative col-span-full xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg text-gray-800 dark:text-gray-100 font-semibold">{t('standard')}</h3>
                  </header>
                  <div className="text-sm mb-2">Ideal for individuals that need a custom solution with custom tools.</div>
                  {/* Price */}
                  <div className="text-gray-800 dark:text-gray-100 font-bold mb-4">
              ...
              <div className="relative col-span-full xl:col-span-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 shadow-sm rounded-b-lg">
                ...
                <div className="px-5 pt-5 pb-6 border-b border-gray-200 dark:border-gray-700/60">
                  <header className="flex items-center mb-2">
                    ...
                    <h3 className="text-lg text-gray-800 dark:text-gray-100 font-semibold">{t('plus')}</h3>
                  </header>
                  <div className="text-sm mb-2">Ideal for individuals that need a custom solution with custom tools.</div>
                  {/* Price */}
                  <div className="text-gray-800 dark:text-gray-100 font-bold mb-4">
                  ...
                  {/* CTA */}
                  <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white w-full">{t('upgrade')}</button>
                </div>
                <div className="px-5 pt-4 pb-5">
                  <div className="text-xs text-gray-800 dark:text-gray-100 font-semibold uppercase mb-4">{t('whatsIncluded')}</div>
                  {/* List */}
        ...
        <section>
          <div className="px-5 py-3 bg-linear-to-r from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04] rounded-lg text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
            <div className="text-gray-800 dark:text-gray-100 font-semibold mb-2 xl:mb-0">{t('contactSalesTitle')}</div>
            <button className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white">{t('contactSales')}</button>
          </div>
        </section>
        ...
        <section>
          <div className="my-8">
            <h2 className="text-2xl text-gray-800 dark:text-gray-100 font-bold">{t('faqs')}</h2>
          </div>
