...
export enum PermissionInput {
  ...
  GENERATE_BATCH_CODE_FROM_ITEM_IDS = "GENERATE_BATCH_CODE_FROM_ITEM_IDS",
  GENERATE_CODEGENERATOR = "GENERATE_CODEGENERATOR",
  GENERATE_DAYSCODE = "GENERATE_DAYSCODE",
  GENERATE_DAYSCODE_V2 = "GENERATE_DAYSCODE_V2",
  GENERATE_DISTRIBUTOR_MQTT_PASSWORD = "GENERATE_DISTRIBUTOR_MQTT_PASSWORD",
  GENERATE_FREECODE_V2 = "GENERATE_FREECODE_V2",
  ...
  GENERATE_RESETCODE_V2 = "GENERATE_RESETCODE_V2",
  ...
  GET_ALL_FLEETS_WITH_ITEM_COUNT = "GET_ALL_FLEETS_WITH_ITEM_COUNT",
  ...
  GET_ITEM_BY_OEMITEMID = "GET_ITEM_BY_OEMITEMID",
  ...
  LOAD_DISTRIBUTOR_DATA_TO_ELASTIC_SEARCH = "LOAD_DISTRIBUTOR_DATA_TO_ELASTIC_SEARCH",
  ...
  LOAD_PERSONS_DATA_TO_ELASTIC_SEARCH = "LOAD_PERSONS_DATA_TO_ELASTIC_SEARCH",
  LOG_EVENT = "LOG_EVENT",
