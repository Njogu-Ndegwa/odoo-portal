...
export const actions = ({ row, onDelete }: ActionProps) => {
    ...
    const handleConfirmDelete = async () => {
        ...
        //     alert({ text: tm('deleteFailed', { entity: 'message group' }), type: "error" })
        // }
    };
    ...
    return (
        <>
            ...
            <FeedbackModal
                ...
                variant="danger"
                title={tm('deleteTitle', { count: 1, entity: 'message group' })}
                content={tm('deleteConfirmation', { entity: 'message group' })}
