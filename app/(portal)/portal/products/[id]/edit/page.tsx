...
import { getProductById, updateProductItem } from '@/lib/services/product-service'
  ...
  useEffect(() => {
    async function load() {
      ...
      try {
        ...
        setForm({
          name: p.name,
          list_price: String(p.listPrice),
          type: p.type || 'service',
          pu_category: (p.puCategory || '') as PuCategory,
          pu_metric: p.puMetric || '',
          ...
          recurring_invoice: p.recurringInvoice,
          sale_ok: p.saleOk,
          external_image_url: p.imageUrl || '',
        })
      } catch (err: unknown) {
          ...
          <div className="p-5">
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <input id="list_price" name="list_price" className="form-input w-full" type="number" min="0" step="0.01" value={form.list_price} onChange={handleChange} required />
              </div>
              <div>
                <label className="block text-sm font-medium mb-1" htmlFor="default_code">SKU</label>
                <input id="default_code" name="default_code" className="form-input w-full" type="text" value={form.default_code} onChange={handleChange} />
              </div>
              <div>
              ...
              <div>
                ...
                <input id="external_image_url" name="external_image_url" className="form-input w-full" type="url" value={form.external_image_url} onChange={handleChange} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-5">
            <div className="grid gap-5 md:grid-cols-1">
              ...
              <div>
                ...
                <textarea id="description_sale" name="description_sale" className="form-textarea w-full" rows={3} value={form.description_sale} onChange={handleChange} />
              </div>
            </div>
          </div>
        </div>
