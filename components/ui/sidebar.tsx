                  ...
                  {(handleClick, open) => {
                    return (
                      <>
                        <a
                          href="#0"
                          className={`block text-gray-800 dark:text-gray-100 truncate transition ${segments.includes("dashboard")
                            ? ""
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <svg
                                className={`shrink-0 fill-current ${segments.includes("dashboard")
                                  ? "text-violet-500"
                      ...
                      <>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <svg
                                className={`shrink-0 fill-current ${segments.includes("finance")
                                    ? "text-violet-500"
                                    : "text-gray-400 dark:text-gray-500"
                                  }`}
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                          <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                            ...
                            <li className="mb-1 last:mb-0">
                              <SidebarLink href="/ecommerce/fleets">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  Fleet
                                </span>
                              </SidebarLink>
                            ...
                            <li className="mb-1 last:mb-0">
                              <SidebarLink href="/ecommerce/distributor-staff">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  Distributor Staff
                                </span>
                              </SidebarLink>
                            ...
                            <li className="mb-1 last:mb-0">
                              <SidebarLink href="/ecommerce/payments">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  Payments
                                </span>
                              </SidebarLink>
                            ...
                            <li className="mb-1 last:mb-0">
                              <SidebarLink href="/ecommerce/paymentsplans">
                                <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                  Payments Plans
                                </span>
                              </SidebarLink>
